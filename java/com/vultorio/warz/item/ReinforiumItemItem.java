...
public class ReinforiumItemItem extends WarZModElements.ModElement {
	@ObjectHolder("war_z:reinforium_item")
	public static final Item block = null;
	public ReinforiumItemItem(WarZModElements instance) {
		super(instance, 29);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("reinforium_item");
		}
