...
public class TestProcedure extends WarZModElements.ModElement {
	public TestProcedure(WarZModElements instance) {
		super(instance, 45);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WarZMod.LOGGER.warn("Failed to load dependency entity for procedure Test!");
			return;
		}
