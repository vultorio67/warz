...
public class CarboneblockBlock extends WarZModElements.ModElement {
	@ObjectHolder("war_z:carboneblock")
	public static final Block block = null;
	public CarboneblockBlock(WarZModElements instance) {
		super(instance, 5);
	}
