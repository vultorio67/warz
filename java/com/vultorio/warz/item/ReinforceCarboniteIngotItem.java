...
public class ReinforceCarboniteIngotItem extends WarZModElements.ModElement {
	@ObjectHolder("war_z:reinforce_carbonite_ingot")
	public static final Item block = null;
	public ReinforceCarboniteIngotItem(WarZModElements instance) {
		super(instance, 32);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("reinforce_carbonite_ingot");
		}
