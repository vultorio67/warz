...
public class CarboneItem extends WarZModElements.ModElement {
	@ObjectHolder("war_z:carbone")
	public static final Item block = null;
	public CarboneItem(WarZModElements instance) {
		super(instance, 1);
	}
