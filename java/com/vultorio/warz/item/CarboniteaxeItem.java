...
public class CarboniteaxeItem extends WarZModElements.ModElement {
	@ObjectHolder("war_z:carboniteaxe")
	public static final Item block = null;
	public CarboniteaxeItem(WarZModElements instance) {
		super(instance, 13);
	}
