...
public class CarboniteingotItem extends WarZModElements.ModElement {
	@ObjectHolder("war_z:carboniteingot")
	public static final Item block = null;
	public CarboniteingotItem(WarZModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("carboniteingot");
		}
